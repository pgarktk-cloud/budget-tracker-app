 ...
 *
 * REMOVED 2026-08-08: `POST /ai/advice`, a Gemini narration of the Purchase
 * Advisor's output (Builds B and C2, v1.36.0–v1.40.0). It was deleted because
 * it did not earn its place, not because it was unsafe — see docs/decisions.md.
 * If anything like it is ever revived, the design that worked is in git
 * history at v1.40.0, and the reasoning behind every guard is in decisions.md.
 * The GEMINI_API_KEY secret was deleted with it.
 *
 * ── How sync is stored ───────────────────────────────────────────────────────
